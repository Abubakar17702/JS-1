...
document.getElementById("showVar").onclick = function () {
  document.getElementById("statement").innerHTML =
    "<h5>Variable Names Legal and Illegal</h5>";
  let html =
...
document.getElementById("showCamelCase").onclick = function () {
  document.getElementById("statement").innerHTML = "";
  document.getElementById("statement").innerHTML =
    "<h5>Examples Of camelCase</h4>";
  let html2 =
    "<ul> <li><code>userName</code></li> <li><code>fullName</code></li> <li><code>watchTime</code></li> </ul>";
...
document.getElementById("sumOfTwo").onclick = function () {
  ...
  document.getElementById("statement").innerHTML =
    "let a = " + a + "<br/> let b = " + b + " <br/>let sum = a+b";
...
document.getElementById("subOfTwo").onclick = function () {
  ...
  console.log("sub=", sub);
  document.getElementById("statement").innerHTML =
    "let a = " + a + "<br/> let b = " + b + " <br/>let sub = a-b";
...
document.getElementById("mulOfTwo").onclick = function () {
  ...
  console.log("mul=", mul);
  document.getElementById("statement").innerHTML =
    "let a = " + a + "<br/> let b = " + b + " <br/>let mul = a*b";
...
document.getElementById("divOfTwo").onclick = function () {
  ...
  console.log("div=", div);
  document.getElementById("statement").innerHTML =
    "let a = " + a + "<br/> let b = " + b + " <br/>let div = a/b";
